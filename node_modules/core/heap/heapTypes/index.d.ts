import { Filter, FilterObject, OrderByDefinition, SortDirection } from 'core/db/dbQueryTypes'
import * as hs from 'core/heap/v2/heapSchemaTypes'
import { HsFilterbleObjectStatic, HsProperties } from 'core/heap/v2/heapSchemaTypes'
import { OptionalHeapTableInfo } from 'core/heap/v2/HeapTableRecordApi'
 ...
 */
export declare class HeapRecordHelperClass {
  id: HeapId
  idx: number
  account_id: number
  type: HeapObjectType
  ...
  updated_at: Date
  searchable_fields_updated_at?: Date | null | undefined
  search_indexes_updated_at?: Date | null | undefined
  constructor(
    id: HeapId,
    idx: number,
    account_id: number,
...
export declare type HeapRecord = PublicFieldsOfClass<HeapRecordHelperClass>
export declare const reservedHeapFieldNames: Set<string>
export declare type HeapId = string
export declare type HeapObjectType = string
export declare type HeapObjectCoord = {
  id: HeapId
  heapType: HeapObjectType
}
export declare type HeapObjectBaseRaw = HeapObjectCoord & {
  createdAt: Date
  updatedAt: Date
}
/**
 ...
 */
export declare type HeapObjectJson = HeapObjectCoord & {
  createdAt: string
  updatedAt: string
...
export declare type HeapOrderBy<HSP extends HsProperties> = OrderByDefinition<HsFilterbleObjectStatic<HSP>>
export declare type HeapRecordSearchByOptions<HSP extends HsProperties> = {
