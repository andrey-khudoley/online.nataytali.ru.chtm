...
import { HsObject, HsProperties, HsProperty } from 'core/heap/v2/heapSchemaTypes'
...
export interface HeapTableRecordApi<ReadCtx, WriteCtx> {
  getRouteSchemaForRef: RouteRefGetSchemaFn
  ...
  queryHeapRecords<HSP extends HsProperties>(
    ...
    heapTypeTransformerFn?: (tableName: string) => HeapObjectType,
  ): Promise<HeapRecord[]>
  ...
  queryHeapRecordsBySearch<HSP extends HsProperties>(
    ctx: ReadCtx & OptionalEnvCtx,
    type: HeapObjectType,
  ...
  runHeapSelectQuery<T extends AnyObject = AnyObject>(ctx: ReadCtx, hql: HqlSelectQuery): Promise<T[]>
  createHeapRecord<HSP extends HsProperties>(
    ctx: WriteCtx,
    type: HeapObjectType,
    tableInfo: OptionalHeapTableInfo,
    linkInfo: HeapLinkInfo[],
    data: tb.Static<HsObject<HSP>> & {
      id?: HeapId
    },
  ): Promise<HeapRecord>
  updateHeapRecordMaybe<HSP extends HsProperties>(
    ...
    tableInfo: OptionalHeapTableInfo,
    linkInfo: HeapLinkInfo[],
    patch: Partial<tb.Static<HsObject<HSP>>> & {
      id: HeapId
    },
    optionalFieldsToClear?: Array<keyof HSP>,
  ): Promise<HeapRecord | null>
  updateHeapRecords<HSP extends HsProperties>(
    ctx: WriteCtx,
    type: HeapObjectType,
    tableInfo: OptionalHeapTableInfo,
    filter: HeapRecordFilter<HSP> | null | undefined,
    limit: number | null,
    linkInfo: HeapLinkInfo[],
    patch: Partial<tb.Static<HsObject<HSP>>>,
    optionalFieldsToClear?: Array<keyof HSP>,
  ...
  deleteHeapRecords<HSP extends HsProperties>(
    ctx: WriteCtx,
    type: HeapObjectType,
    tableInfo: OptionalHeapTableInfo,
    filter: HeapRecordFilter<HSP> | null | undefined,
  ...
  createOrUpdateSingleton<HSP extends HsProperties>(
    ...
    createData: tb.Static<HsObject<HSP>>,
    updateLinkInfo: HeapLinkInfo[],
    updatePatch: Partial<tb.Static<HsObject<HSP>>>,
    optionalFieldsToClear?: Array<keyof HSP>,
  ): Promise<HeapRecord>
}
/**
 * Represents a single link info collected during heap object serialization
 *  to facilitate links validation and tracking during saving the record to the db.
 * The type supports both present and empty link values.
 */
export declare type HeapLinkInfo =
  | {
      refType: 'RefLink'
      fieldPath: string
...
/**
 * Hints to pass some repo info from ugc-side to backend-side
 */
export declare type HeapTableInfo = {
  searchableInfo?: {
    fields: Record<
      string,
      {
...
export declare type OptionalHeapTableInfo = null | undefined | HeapTableInfo
