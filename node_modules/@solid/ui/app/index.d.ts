...
import type { SubmitFormAction as OriginalSubmitFormAction, ShowToastAction as OriginalShowToastAction, ShowContextMenuAction as OriginalShowContextMenuAction, CopyToClipboardAction as OriginalCopyToClipboardAction, ShowTextDialogAction as OriginalShowTextDialogAction, NavigateAction as OriginalNavigateAction } from '@app/ui';
export { Confirm };
...
export interface NavigateAction extends OriginalNavigateAction {
    type: 'navigate';
    url: string;
}
/**
...
export declare function processCopyToClipboard(action: CopyToClipboardAction): Promise<boolean>;
export declare function isCopyToClipboardAction(action: any): action is CopyToClipboardAction;
export interface CopyToClipboardAction extends OriginalCopyToClipboardAction {
}
/**
 ** end copyToClipboard ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
 **/
/**
 ** start showTextDialog ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
 **/
export declare function showTextDialog(params: Omit<ShowTextDialogAction, 'type'>): ShowTextDialogAction;
export declare function processShowTextDialog(action: ShowTextDialogAction, event?: OriginalEvent): Promise<boolean>;
export declare function isShowTextDialogAction(action: any): action is ShowTextDialogAction;
export interface ShowTextDialogAction extends OriginalShowTextDialogAction {
}
/**
 ** end showTextDialog ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
 **/
export type AppUiAction = RefreshAction | NavigateAction | ShowToastAction | ApiCallAction | SubmitFormAction | ShowContextMenuAction | CopyToClipboardAction | ShowTextDialogAction;
