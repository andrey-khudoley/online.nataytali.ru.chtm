...
export declare type InitializerComponent<P, E extends Element> = {
...
export declare type SolidComponent<Props> = {
  (
    props: Props & {
      ctx: InitializerCtx
    },
...
export declare function renderHtmlNodeToString(ctx: RichUgcCtx, res: HtmlNodeChild): Promise<string>
export * from 'lib/html-jsx'
